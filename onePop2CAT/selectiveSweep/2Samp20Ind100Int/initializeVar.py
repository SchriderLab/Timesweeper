baseDir="/pine/scr/e/m/emae/data/popGenCnn/timeSeriesSweeps/onePop2CAT/selectiveSweep/2Samp20Ind100Int"
...
sampleSizePerStep1Samp = 40 #size of population sampled at one time point so that it is same size as time series data
